...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Units/GreatGeneral/04_GameAssets/Textures/Jeep_Destoryed_ao.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2165843318</m_ExportedTime>
	<m_ClassName text="Generic_AO"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMP_GARBAGE_TIRE_ao.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMP_GARBAGE_TIRE_ao"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
