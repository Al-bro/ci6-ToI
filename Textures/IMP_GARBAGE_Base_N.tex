...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/CIV 6 - ToI\Textures\IMP_GARBAGE_Base_N.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2241753596</m_ExportedTime>
	<m_ClassName text="Generic_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMP_GARBAGE_Base_N.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMP_GARBAGE_Base_N"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
