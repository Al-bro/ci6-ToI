...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Terrain/Features/Floodplains/03_textures/TER_TarPit_Decal_H.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>917227943</m_ExportedTime>
	<m_ClassName text="Decal_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMP_GARBAGE_TarPit_Decal_H.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMP_GARBAGE_TarPit_Decal_H"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
