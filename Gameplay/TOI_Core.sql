...
--===========================================================================================================================================================================--
		...
		INSERT INTO Buildings
			(	BuildingType,       				Name,       										PrereqTech,					PrereqCivic,   					 Cost,      	 MaxPlayerInstances,    PrereqDistrict,       				Description,										Maintenance,    CitizenSlots,   		RegionalRange,			PurchaseYield,		ObsoleteEra,		    AdvisorType      			)	VALUES
																								
			(	'BUILDING_TOI_T1_01',				'LOC_BUILDING_TOI_T1_01_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T1_01_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T1_02',				'LOC_BUILDING_TOI_T1_02_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T1_02_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T1_03',				'LOC_BUILDING_TOI_T1_03_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T1_03_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T2_01',				'LOC_BUILDING_TOI_T2_01_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T2_01_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T2_02',				'LOC_BUILDING_TOI_T2_02_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T2_02_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T2_03',				'LOC_BUILDING_TOI_T2_03_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T2_03_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T3_01',				'LOC_BUILDING_TOI_T3_01_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T3_01_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T3_02',				'LOC_BUILDING_TOI_T3_02_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T3_02_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_TOI_T3_03',				'LOC_BUILDING_TOI_T3_03_NAME',						NULL,						NULL,							'330',			'-1',					'DISTRICT_INDUSTRIAL_ZONE', 		'LOC_BUILDING_TOI_T3_03_DESCRIPTION',				'4',			'1',					'6',					'YIELD_GOLD',		'NO_ERA',				'ADVISOR_GENERIC'			);
